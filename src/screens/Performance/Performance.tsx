...
export function Performance() {
  ...
  const [todayIncome, setTodayIncome] = useState(26000);
  ...
  const handleRefresh = async () => {
    ...
    setTodayIncome((prev) => prev + Math.floor(Math.random() * 2000));
    setWalletBalance((prev) => prev + Math.floor(Math.random() * 500));
    setBonuses((prev) => prev + Math.floor(Math.random() * 3));
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen bg-white flex flex-col max-w-[360px] mx-auto relative font-sans overflow-y-auto"
      style={{
        transform: isPulling
        ...
        <div className="flex justify-between items-center px-4 pb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span
              ...
              style={{
                fontFamily:
                  "SF Pro Text, Noto Sans, Helvetica, Arial, sans-serif",
              }}
            >
              20:30
            </span>
        ...
        <div className="px-4">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span
                  className="text-2xl font-extrabold text-white leading-7 tracking-tight"
                  style={{
          ...
          <div className="bg-white/20 rounded-2xl p-4 mb-4">
            <div className="text-white text-sm mb-2 font-medium">
              Rides for Platinum completed
            </div>
            <div className="flex items-center gap-2">
              <div className="flex-1">
                <div className="w-full h-2.5 bg-white/20 rounded-full relative">
                  <div
                    className="h-2.5 bg-white rounded-full absolute left-0 top-0"
                    style={{ width: "100%" }}
                  ></div>
                </div>
              </div>
          ...
          <Button className="w-full bg-white text-[#323942] hover:bg-white/90 font-semibold py-3 rounded-2xl mb-4 shadow-md text-base">
            See benefits
          </Button>
        </div>
      </div>
      ...
      <div className="bg-white rounded-t-3xl flex-1 px-4 pt-4 pb-32 -mt-4">
        <div className="mb-4">
          <div className="flex items-center justify-between mb-1">
            <span className="text-[#6A6B6E] text-sm font-medium">
              Today's income
            </span>
            <svg
              className="w-5 h-5 text-[#6A6B6E]"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <div className="flex items-end justify-between mb-1">
            <span className="text-3xl font-extrabold text-[#141414] leading-8">
              {todayIncome.toLocaleString()} ₸
            </span>
            <span className="text-[#6A6B6E] text-base font-medium">
              35 000 ₸
            </span>
          </div>
          <div className="w-full h-2.5 bg-[#E6E6E6] rounded-full relative">
            <div
              className="h-2.5 bg-black rounded-full absolute left-0 top-0"
              style={{ width: "74%" }}
            ></div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between py-3 border-b border-[#E6E6E6]">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-lg font-bold text-[#141414]">{bonuses}</div>
